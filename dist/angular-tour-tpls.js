...
(function (window, document, undefined) {
  ...
  angular.module('angular-tour.tour', []).constant('tourConfig', {
	...
	animation: true,
	nextLabel: 'Next',
	secondLabelFunction: false,
	secondLabelText: false,
	scrollSpeed: 500,
	margin: 28,
	backDrop: false,
	...
	function ($window, $compile, $interpolate, $timeout, scrollTo, tourConfig) {
	  ...
	  return {
		...
		link: function (scope, element, attrs, tourCtrl) {
		  ...
		  attrs.$observe('tourtipSecondLabelFunction', function (val) {
			scope.ttSecondLabelFunction = val || tourConfig.secondLabelFunction;
		  });
		  attrs.$observe('tourtipSecondLabelText', function (val) {
			scope.ttSecondLabelText = val || tourConfig.secondLabelText;
		  });
		  ...
		  scope.ttSecondLabelText = tourConfig.secondLabelText;
		  scope.ttSecondLabelFunction = tourConfig.secondLabelFunction;
