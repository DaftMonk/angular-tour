...
angular.module('angular-tour.tour', [])
  .constant('tourConfig', {
     ...
     * orderedList factory provides an instance method.
     * As a singleton, a tour directive has the steps
     * as global. Having an instance, each tour will have their own
     * copy of the steps which is desired 
     */
