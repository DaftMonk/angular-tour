...
describe('Directive: tour', function () {
  ...
  describe('basics', function() {
    ...
    beforeEach(function() {
      ...
      tip1 = angular.element('<span tour-tip="feature 1!" step="0" next-label="Next" placement="top" class="btn">' +
        'Important website feature' +
        '<a href="#" tour-next></a>' +
        '</span>');

      tip2 = angular.element('<span tour-tip="feature 2!" step="1" next-label="Next" placement="top" class="btn">' +
  ...
  describe('tour controller', function() {
    var scope, ctrl, mockCookieService;
    ...
    beforeEach(function() {
      ...
      scope = $rootScope.$new();
      ctrl = $controller('TourController', {$scope: scope,  $cookieStore: mockCookieService});
    ...
    it('should set tour to completed when you reach end', inject(function (tourConfig) {
      expect(mockCookieService.get(tourConfig.cookieName + '_completed')).toBe(undefined);
      ctrl.startTour();
      ctrl.next();
      ctrl.next();
      ctrl.next();
      expect(mockCookieService.get(tourConfig.cookieName + '_completed')).toBe(true);
    }));
